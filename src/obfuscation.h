...
static const CAmount OBFUSCATION_POOL_MAX = (49999.99 * COIN);
...
{
public:
    /// Is the inputs associated with this public key? (and there is 5000 MRQ - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of BSG.
