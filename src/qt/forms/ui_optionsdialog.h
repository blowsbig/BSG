...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeBSG = new QSpinBox(tabMain);
        anonymizeBSG->setObjectName(QStringLiteral("anonymizeBSG"));
        anonymizeBSG->setMinimum(100);
        anonymizeBSG->setMaximum(100000);
        anonymizeBSG->setSingleStep(100);
        anonymizeBSG->setValue(1000);

        horizontalLayout->addWidget(anonymizeBSG);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start MRQ after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start MRQ on system login", 0));
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("OptionsDialog", "This setting determines the amount of individual masternodes that an input will be anonymized through.<br/>More rounds of anonymization gives a higher degree of privacy, but also costs more in fees.", 0));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("OptionsDialog", "Obfuscation rounds to use", 0));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("OptionsDialog", "This amount acts as a threshold to turn off Obfuscation once it's reached.", 0));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of MRQ to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the MRQ client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the MRQ network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting MRQ.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/BSGcoin/BSGcoin-translations", 0));
