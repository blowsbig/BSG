...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MRQ address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BSG: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BSG"), this);
    aboutAction->setStatusTip(tr("Show information about BSG"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MRQ"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MRQ addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MRQ addresses"));
    ...
    openAction->setStatusTip(tr("Open a MRQ: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BSG help message to get a list with possible MRQ command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BSG client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MRQ network", "", count));
}
...
{
    QString strTitle = tr("BSG"); // default title
