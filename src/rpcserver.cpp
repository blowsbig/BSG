...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BSG features */
        {"BSG", "masternode", &masternode, true, true, false},
        {"BSG", "listmasternodes", &listmasternodes, true, true, false},
        {"BSG", "getmasternodecount", &getmasternodecount, true, true, false},
        {"BSG", "masternodeconnect", &masternodeconnect, true, true, false},
        {"BSG", "masternodecurrent", &masternodecurrent, true, true, false},
        {"BSG", "masternodedebug", &masternodedebug, true, true, false},
        {"BSG", "startmasternode", &startmasternode, true, true, false},
        {"BSG", "createmasternodekey", &createmasternodekey, true, true, false},
        {"BSG", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"BSG", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"BSG", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"BSG", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"BSG", "getmasternodescores", &getmasternodescores, true, true, false},
        {"BSG", "mnbudget", &mnbudget, true, true, false},
        {"BSG", "preparebudget", &preparebudget, true, true, false},
        {"BSG", "submitbudget", &submitbudget, true, true, false},
        {"BSG", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"BSG", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"BSG", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"BSG", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"BSG", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"BSG", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"BSG", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"BSG", "checkbudgets", &checkbudgets, true, true, false},
        {"BSG", "mnsync", &mnsync, true, true, false},
        {"BSG", "spork", &spork, true, true, false},
        {"BSG", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"BSG", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use BSGd, or the -server option to BSG-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"MRQ Alert\" admin@foo.com\n"),
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:55611/\n";
}
