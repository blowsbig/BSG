/* src/config/BSG-config.h.  Generated from BSG-config.h.in by configure.  */
/* src/config/BSG-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "BSG Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BSG Core 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "BSG"
