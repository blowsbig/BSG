...
// Copyright (c) 2015-2017 The PIVX Developers, The BSG Developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x1168702b58250f548248151310fbb1ca5f7cc5dc2ab4260a0cd22ded31ce8818"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1527753600, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "2018-31-05 Blowsbig entered the blockchain";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1527753600;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 300683;

        hashGenesisBlock = genesis.GetHash();


        assert(hashGenesisBlock == uint256("0x1168702b58250f548248151310fbb1ca5f7cc5dc2ab4260a0cd22ded31ce8818"));
        assert(genesis.hashMerkleRoot == uint256("0x015d52a06332f474dfff654d9cd332e18514f32823dd4c42bd328fccb9073f54"));

        vSeeds.push_back(CDNSSeedData("server_1", "blowsbig.com"));
        vSeeds.push_back(CDNSSeedData("server_2", "81.169.157.191"));
        ...
        //  BIP44 coin type is from https://github.com/satoshilabs/slBSG/blob/master/slip-0044.md
