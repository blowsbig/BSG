...
In order to support loading of multiple wallets in BSG-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is BSG.cpp.
...
Changes to BSG.cpp
----------------------
BSG.cpp is the entry point into BSG-qt, and as such, will require some minor modifications to provide hooks for
