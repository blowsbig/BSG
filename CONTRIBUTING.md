...
The BSG project operates an open contributor model where anyone is
...
The following applies to code changes to the BSG project, and is not to be
confused with overall MRQ Network Protocol consensus changes.

Whether a pull request is merged into BSG rests with the project merge
...
Patches that change MRQ consensus rules are considerably more involved than
...
Where a patch set proposes to change the MRQ consensus, it must have been
...
The project leader is the release manager for each BSG release.
